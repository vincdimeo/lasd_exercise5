...
template <typename Data>
void InsertC(uint& testnum, uint& testerr, lasd::DictionaryContainer<Data>& con, const lasd::LinearContainer<Data>& lc) {
  testnum++;
  bool tst = true;
  try {
...
template <typename Data>
void InsertM(uint& testnum, uint& testerr, lasd::DictionaryContainer<Data>& con, lasd::LinearContainer<Data>&& lc) {
  testnum++;
  bool tst = true;
  try {
    std::cout << " " << testnum << " (" << testerr << ") Insertion in the dictionary container of the values of the given linear container: ";
...
template <typename Data>
void Remove(uint& testnum, uint& testerr, lasd::DictionaryContainer<Data>& con, const lasd::LinearContainer<Data>& lc) {
  testnum++;
  bool tst = true;
  try {
